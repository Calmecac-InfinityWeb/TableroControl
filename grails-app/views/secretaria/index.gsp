		...
		<div id="list-secretaria" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nombreSecretaria" title="${message(code: 'secretaria.nombreSecretaria.label', default: 'Nombre Secretaria')}" />
				...
				<g:each in="${secretariaInstanceList}" status="i" var="secretariaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${secretariaInstance.id}">${fieldValue(bean: secretariaInstance, field: "nombreSecretaria")}</g:link></td>
