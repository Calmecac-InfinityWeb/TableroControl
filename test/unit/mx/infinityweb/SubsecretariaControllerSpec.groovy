...
class SubsecretariaControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
        ...
        then:"The model is correct"
            !model.subsecretariaInstanceList
            model.subsecretariaInstanceCount == 0
    }
    ...
    void "Test the create action returns the correct model"() {
        ...
        then:"The model is correctly created"
            model.subsecretariaInstance!= null
    }
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        then:"A redirect is issued to the show action"
            response.redirectedUrl == '/subsecretaria/show/1'
    ...
    void "Test that the show action returns the correct model"() {
        ...
        when:"A domain instance is passed to the show action"
            populateValidParams(params)
            def subsecretaria = new Subsecretaria(params)
            controller.show(subsecretaria)

        then:"A model is populated containing the domain instance"
            model.subsecretariaInstance == subsecretaria
    }
    ...
    void "Test the update action performs an update on a valid domain instance"() {
        ...
        then:"A 404 error is returned"
            response.redirectedUrl == '/subsecretaria/index'
            flash.message != null
        ...
        then:"A redirect is issues to the show action"
            response.redirectedUrl == "/subsecretaria/show/$subsecretaria.id"
            flash.message != null
    }
